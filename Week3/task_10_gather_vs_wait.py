...
async def main():
    # Case A: Using gather() to run tasks concurrently and collect results
    ...
    # Case B: Using wait() to run tasks concurrently and control their execution
    ...
    # Clean up: Cancel any remaining tasks to avoid unnecessary execution
    for t in pending:
        t.cancel()
